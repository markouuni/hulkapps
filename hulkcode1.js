  ...
  window.commonJS = function($){
    ...
    window.hulkappsShowCartDiscounts = function(discounts) {
        ...
        if (discounts.discount_code && discounts.discount_error == 1){
          ...
          jQuery(".hulkapps_summary").remove();
          jQuery(".hulkapps_discount_hide").after("<span class='hulkapps-summary-line-discount-code'><span class='discount-tag'>"+ discounts.discount_code +"<span class='close-tag'></span></span>Free Shipping");
    ...
    window.hulkappsStart = function($) {
                  ...
                  setTimeout(function(){
                    ...
                    if(data['condition'] != undefined){
                      ...
                      $.each(data['condition'], function(index, con){
                        ...
                        $.each(conditions['rules'], function(index, rule){
                          ...
                          if(data['option_id_array'].includes(option_id)){
                    ...
                    if(data['relationship_option'].length != 0){
                      ...
                      $.each(data['relationship_option'], function(key, val){
                        ...
                        var required = val[1]
                        if(data['option_id_array'].includes(option)){
                          ...
                          if(option_type == 'dropdown'){
                            ...
                            $.each(values_json, function(index,ovalue){
                              var price = ovalue[1]
                              var vp1=(price != null ) ? " [ "+data['currency_symbol']+price+" ]" : ""
                              var vp2=(price != null) ? "(+"+data['currency_symbol']+price+")" : ""
                              var vprice=(price != null) ? price:'0.00'
                            ...
                            var selection_text = (min_selection != '0' && max_selection != '0' && data['is_pro']) ? '[Choose from '+ min_selection +' to '+ max_selection +' values]' : (min_selection != '0' && data['is_pro']) ? '[Choose atleast '+ min_selection +' values]' : (max_selection != '0' && data['is_pro']) ? '[Choose upto '+ max_selection +' values]': ''
                            ...
                            if(default_count > 0){
                              if (min_selection != '0' && max_selection != '0' && data['is_pro']){
                              ...
                              else if(min_selection != '0'  && max_selection == '0' && data['is_pro']){
                            ...
                            $.each(values_json, function(index,ovalue){
                              ...
                              var vp1=(price != null ) ? " [ "+data['currency_symbol']+price+" ]" : ""
                              var vp=(price != null) ? "(+"+data['currency_symbol']+price+")" : ""
                              var vprice=(price != null) ? price:'0.00'
                              var opt_class = vprice != '' ? 'price-change' : ''
                            ...
                            var validation_error = '<span class=\"validation_error error_span\" >'
                            html += "<input class='hulkapps_option_child' value='"+valueofhiddenprop.join(', ')+"' type='hidden' id='hulkapps_option_"+option_id+"_hidden' name='properties["+option_name+"]'><script>$(document).on('click','.hulkapps_option_"+option_id+"_visible', function() {if (("+min_selection+" != 0) && ("+max_selection+" != 0) && ("+data['is_pro']+")) {if (($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length) < parseInt('"+min_selection+"')) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();$(this).parents('.hulkapps_option').append('"+validation_error+"Choose from "+min_selection+" to "+max_selection+" values</span>');if (($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length) == 0) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();}} else if (($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length) > parseInt('"+max_selection+"')) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();$(this).parents('.hulkapps_option').append('"+validation_error+"Choose from "+min_selection+" to "+max_selection+" values</span>');if (($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length) != parseInt('"+max_selection+"')) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();}this.checked = false;} else {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();}} else if ("+min_selection+" != 0 && ("+data['is_pro']+")) {if (($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length) < parseInt('"+min_selection+"')) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();$(this).parents('.hulkapps_option').append('"+validation_error+"Choose atleast "+min_selection+" values</span>');} else {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();}} else if ("+max_selection+" != 0 && ("+data['is_pro']+")) {if (parseInt('"+max_selection+"') >= ($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length)) {if (parseInt('"+max_selection+"') == ($('.hulkapps_option_"+option_id+"_visible:checkbox:checked').length)) {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();} else {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();$(this).parents('.hulkapps_option').append('"+validation_error+"Choose upto "+max_selection+" values</span>');}} else {$(this).parents('.hulkapps_option').removeClass('validation_error').find('.error_span').remove();this.checked = false;}}conditional_rules("+data['pid']+");var chkMulti = $.map($('.hulkapps_option_"+option_id+"_visible:checked'), function(el, i) {return $(el).val();});$('#hulkapps_option_"+option_id+"_hidden').val(chkMulti.join(', '));if($('#hulk_amount_dis').val() == '1'){calc_options_total("+data['pid']+");}validate_single_option('option_type_id_"+option_id+"', 'cb_render');});</script></div></div>"

                            all_html = all_html + html
                          }else if(option_type=='textbox'){
                            var cc = ''
                            var is_option_limit = option_limit != undefined && data['is_pro'] && option_limit['character_limit'] != '' && option_limit['character_limit'] != undefined ? '[Maximum '+ option_limit['character_limit']+' character]' : ''
                            ...
                            $.each(values_json, function(index,ovalue){
                              ...
                              var maxlength_limit = ''
                              var opt_class = vprice != '' ? 'price-change' : ''
                              if(option_limit != undefined && data['is_pro'] && option_limit['character_limit'] != '' && option_limit['character_limit'] != undefined){
                            ...
                            cc = ''
                            var char_limit = option_limit != undefined && data['is_pro'] && option_limit['character_limit'] != '' && option_limit['character_limit'] != undefined
                            var is_option_limit = option_limit != undefined && data['is_pro'] && option_limit['character_limit'] != '' && option_limit['character_limit'] != undefined  ? '[Maximum '+ option_limit['character_limit']+' character]' : ''
      ...
      if(window.hulkapps.page_type == "cart"){
        ...
        if (storage_code != ''){
          ...
          var get_cart_data = {cart_data: window.hulkapps,store_id: window.hulkapps.store_id, discount_code: storage_code, cart_collections: JSON.stringify(window.hulkapps.cart_collections)}
        }else{
          var get_cart_data = {cart_data: window.hulkapps,store_id: window.hulkapps.store_id}
        }
        var count=0
